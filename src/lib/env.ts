...
export const env = {
    ...
    get KAKAO_BIZ_MESSAGE_ENDPOINT() {
        return cleanEnv(process.env.KAKAO_BIZ_MESSAGE_ENDPOINT)
    },
    get KAKAO_BIZ_MESSAGE_TOKEN() {
        return cleanEnv(process.env.KAKAO_BIZ_MESSAGE_TOKEN)
    },
    get TEACHER_CONTACT_EMAIL() {
        return cleanEnv(process.env.NEXT_PUBLIC_TEACHER_CONTACT_EMAIL)
    },
    get TEACHER_DISPLAY_NAME() {
        return cleanEnv(process.env.NEXT_PUBLIC_TEACHER_DISPLAY_NAME) || '선생님'
    },
    get PARENT_SESSION_SECRET() {
        return cleanEnv(process.env.PARENT_SESSION_SECRET)
    },
    ...
    get VAPID_SUBJECT() {
        return cleanEnv(process.env.VAPID_SUBJECT) || 'mailto:admin@codingssok.com'
    },
}
