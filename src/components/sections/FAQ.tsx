...
const FAQ_ITEMS = [
    ...
    },
    {
        ...
        answer: "1:4~1:6 소수정예 대면 수업으로, 아이의 수준에 맞춘 개별 커리큘럼을 제공합니다. 1회 수업은 120분이며 복습·개념·코딩 실습·프로젝트·성장 기록 순서로 운영합니다. 주 1회 학생은 기본 진도로, 주 2회 학생은 같은 과정을 빠른 진도로 이어가며 선생님이 코드와 결과물을 직접 확인합니다.",
        icon: "groups",
        defaultOpen: true,
    },
    {
