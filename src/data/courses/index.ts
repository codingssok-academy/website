...
export const COURSES: Course[] = [
    ...
    },
    {
        ...
        cardImage: '/images/courses/cpp-v2.png',
    ...
    },
    {
        id: '5',
        title: '게임 제작',
        subtitle: 'Roblox Studio · Luau · 게임디자인',
        icon: 'sports_esports',
        gradient: 'linear-gradient(135deg, #2563eb, #0ea5e9)',
        cardImage: '/images/courses/game-dev.png',
        description: '초등 4~6학년을 위한 120분 수업 24회 게임 메이커 과정입니다. 3D 월드·Luau 코딩·게임 시스템·플레이테스트를 거쳐 창작게임과 포트폴리오를 완성합니다.',
        totalUnits: 24,
        totalProblems: 0,
        estimatedHours: 48,
